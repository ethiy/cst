...
\renewcommand{\footnotetext}{\scriptsize}
    ...
    \section{Introduction}
        \subsection{Context}
                ...
                \uncover<3->{
                    \begin{figure}[H]
                        \begin{center}
                            ...
                            \caption{\label{fig::lods_citygml} \gls{lod}~\footcite{kolbe2005citygml} representation as defined in the \emph{cityGML} format.}
                        \end{center}
                    \end{figure}
                }
            \end{frame}
            ...
            \begin{frame}{Urban models applications}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> Urban models have a wide application range~\footcite{Biljecki2015};
                \end{itemize}
                \uncover<2->{
                    \begin{table}
                        \begin{center}
        ...
        \subsection{Motivation}
            \begin{frame}{The need for self diagnostic}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> Automatic urban modeling is an active research area~\footcite{Musialski2012}, but not \textcolor{IGNRed}{yet operational}~\footcite{rottensteiner2014results}:
                    \begin{itemize}[label=--]
                    ...
                    \end{itemize}
                    \item<2-> Urban $3D$ model semantic diagnostic is not well studied~\footcite{nguatem2017modeling}.
                \end{itemize}
                ~\\
                \uncover<3->{
    ...
    \section{State of the art}
        ...
        \subsection{Different types of reference data}
            \begin{frame}{Manual reference data}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> geodetic measurements ($ \sigma \sim \SI{0.05}{m}$)~\footcite{Voegtle2003};
                    \item<2-> stereo plotting~\footcite{Zeng2014}.
                \end{itemize}
                \uncover<3->{
                    Disadvantages:
            ...
            \begin{frame}{Sensor data}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> \gls{lidar}~\footcite{Akca2010};
                    \item<2-> oriented aerial images~\footcite{Michelin2013}.
                \end{itemize}
                \uncover<3->{
                    Disadvantages:
                    \begin{itemize}[label=$-$, font=\color{IGNRed}]
        ...
        \subsection{Different types of output}
            \begin{frame}{Geometric precision indices}
                ...
                At different scales:
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> Points of interest average precision~\footcite{Voegtle2003},
                    \item<2-> Surface discrepency to reference data~\footcite{Henricsson1997},
                    \item<3-> Volume discrepency to reference data~\footcite{Zeng2014}.
                \end{itemize}
                \uncover<4->{
                    Disadvantages:
                    \begin{itemize}[label=$-$, font=\color{IGNRed}]
            ...
            \begin{frame}{Semantic errors}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> visual inspection~\footcite{OudeElberink2010};
                    \item<2-> supervized learning, detecting errors from a taxonomy based on:
                    \begin{itemize}[label=--]
                        \item<3-> traffic lights paradigm~\footcite{boudet2006supervised};
                        \item<4-> a list of reconstruction errors~\footcite{Michelin2013}.
                    \end{itemize}
                \end{itemize}
                \uncover<5->{
                    Risk:
        ...
        \begin{frame}{How to predict reconstruction errors?}
            ...
            \begin{enumerate}[label = (\roman*)., font=\color{IGNGreen}]
                ...
                \begin{itemize}[label=--]
                    ...
                    \item<5-> the corresponding \gls{dsm} (photo point cloud);
        ...
        \subsection{Pipeline}
            ...
            \begin{frame}{The Qualification pipeline}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<4-> Using a supervised classifer, trained with the defined taxonomy and parameters, we \textcolor{IGNDarkOrange}{predict} the building $3D$ model quality.
                \end{itemize}
            \end{frame}
        ...
        \subsection{Results}
            \begin{frame}{Used Data}
                \begin{itemize}[leftmargin=6em, font=\color{IGNDarkGreen}]
                    ...
                    \item[Algorithm:]<5-> $\text{Bati3D}^\text{\textregistered}$~\footcite{Durupt2006}.
                \end{itemize}
            \end{frame}
        ...
        \subsection{Data augmentation}
            ...
            \begin{frame}{More scenes}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<2-> A group of students (ENSG) reconstructed Elancourt and Toulouse using the \emph{3dfier} program~\footcite{ledoux2011topologically}: $\gls{lod} = 1$;
                    \item<3-> We can compare with other reconstruction methods~\footcite{Lafarge2012,kelly2017bigsur}.
                \end{itemize}
            \end{frame}
