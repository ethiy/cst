            ...
            \begin{frame}{Random Forest}
                ...
                \uncover<3->{
                    ...
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        ...
                        \item<5-> $1000$ trees to cover the whole the attributes space.
                    \end{itemize}
                }
            \end{frame}
        ...
        \subsection{Results}
            ...
            \begin{frame}{Discussion}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<3-> Geometric features alone can predict errors with a comparable order of accuracy as with all features. It can even outperform alone for some individual cases (\textbf{Building under segmentation}).
                \end{itemize}
            \end{frame}
